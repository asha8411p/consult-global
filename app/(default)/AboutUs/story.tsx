      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <div className="pb-12 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            Welcome to Consult Global, your trusted partner in international education. We are headquartered in Sydney, Australia. Over the years, we have built a reputation for providing top-quality guidance and support to students aspiring to study abroad.
            </p>
            <p className="text-lg text-gray-600 mb-8">
            Our extensive global network includes partnerships with leading educational institutions in Australia, New Zealand, Canada, and United Kingdom. This allows us to connect you with a world of opportunities and help you achieve your academic dreams in a multicultural environment.
            </p>
            <p className="text-lg text-gray-600 mb-8">
            At Consult Global, we pride ourselves on offering personalised and reliable career counselling. Our dedicated counsellors take the time to understand your unique aspirations and abilities through in-depth, one-on-one conversations. We then match you with the courses and universities that best suit your goals and strengths, ensuring a smooth and stress-free path to success.
            </p>
            <p className="text-lg text-gray-600 mb-8">
            Join us at Consult Global, where your educational journey begins with expert advice and unwavering support. Let us help you unite with the world and accomplish your academic goals.
            </p>
          </div>
