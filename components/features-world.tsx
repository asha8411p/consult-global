  ...
  return (
    <section>
      ...
      <h1 className="h2 mb-4">
        <span className="text-black">CONSULT </span>
        <span className="bg-gradient-to-r from-blue-600 via-blue-500 to-blue-400 bg-clip-text text-transparent">GLOBAL</span>
        <span className="text-black">: Simplifying Your International Expansion</span>
      </h1>
      <p className="text-xl text-gray-600">
        Helping students, professionals, and business owners migrate and expand to Australia with ease.
      </p>
    </div>
