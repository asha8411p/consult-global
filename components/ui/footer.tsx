    ...
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="text-sm">
              <li className="mb-2">
                <a href="/StudyInAustralia" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Study in Australia</a>
              </li>
              <li className="mb-2">
                <a href="/Migration" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Migration</a>
              </li>
              <li className="mb-2">
                <a href="ImportExport" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Import/Export</a>
              </li>
              <li className="mb-2">
                <a href="PostLanding" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Post-landing services</a>
              </li>
            </ul>
          </div>
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="text-sm">
              ...
              <li className="mb-2">
                <a href="/AboutUs" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">About us</a>
              </li>
              <li className="mb-2">
                <a href="/WhyUs" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Why Us?</a>
              </li>
              <li className="mb-2">
                <a href="/FAQs" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">FAQs</a>
              </li>
              <li className="mb-2">
                <a href="/ContactUs" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Contact Us</a>
              </li>
            </ul>
          </div>
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4">&copy; consultglobal.com. All rights reserved.</div>
